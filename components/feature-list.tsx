...
function ChipTab({
  ...
  return (
    ...
    >
      {chip.icon && (
        <span className={cx('[&>svg]:size-4', active ? 'text-background/90' : 'text-current')}>
          {chip.icon}
        </span>
      )}
  ...
  return (
    <section className="w-full py-8 md:py-16">
      <div className="container p-0">
        ...
        <div className="relative mt-10" role="tablist" aria-label="Профессии">
          <Marquee items={chips} activeId={activeId} onSelect={setActiveId} duration="150s" />
